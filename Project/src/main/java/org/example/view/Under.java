...
//        draggable(gridPane);
        ...
        Image tower = new Image(GameMenu.class.getResource("/Images/buildings2/castle buildings/sag.png").toExternalForm());
        ...
        Image gate = new Image(Under.class.getResource("/Images/buildings2/castle buildings/sag2.png").toExternalForm());
    ...
    public static void dragDrop(ImageView... imageView){
        ...
        for (ImageView imageViews:imageView){
            ...
            imageViews.setOnMouseReleased(e -> {
                ...
                int col=  ((int) e.getSceneY()/100 +(int) (scrollPositionV*100));
                int row=  ((int) e.getSceneX()/100 +(int) (scrollPositionH*100));
    ...
    public static Pane castleBuildings()  {
        ...
        Image image = new Image(Under.class.getResource("/Images/buildings2/castle buildings/castleBuil.png").toExternalForm());
        ...
        Image image1 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/castle1.png").toExternalForm());
        ImageView imageView1 = new ImageView(image1);
        ...
        Image image2 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/castle2.png").toExternalForm());
        ImageView imageView2 = new ImageView(image2);
        ...
        Image image4 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/castle4.png").toExternalForm());
        ImageView imageView4 = new ImageView(image4);
        ...
        Image image6 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/castle6.png").toExternalForm());
        ImageView imageView6 = new ImageView(image6);
    ...
    public static Pane tower(){
        ...
        Image gh = new Image(Under.class.getResource("/Images/buildings2/castle buildings/t1.png").toExternalForm());
        ...
        Image gh1 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/t2.png").toExternalForm());
        ...
        Image gh2 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/t3.png").toExternalForm());
    ...
    public static Pane gate(){
        ...
        Image gh = new Image(Under.class.getResource("/Images/buildings2/castle buildings/gh.png").toExternalForm());
        ImageView ghView = new ImageView(gh);
        ghView.setFitWidth(35);
        ghView.setFitHeight(85);
        ghView.setX(400);
        ...
        Image gh1 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/khar.png").toExternalForm());
        ImageView gh1View = new ImageView(gh1);
        gh1View.setFitWidth(75);
        gh1View.setFitHeight(75);
        gh1View.setX(475);
        ...
        Image gh2 = new Image(Under.class.getResource("/Images/buildings2/castle buildings/gh2.png").toExternalForm());
        ImageView gh2View = new ImageView(gh2);
        gh2View.setFitWidth(75);
        gh2View.setFitHeight(75);
        gh2View.setX(560);
        ...
        Image ghh = new Image(Under.class.getResource("/Images/buildings2/castle buildings/ghh.png").toExternalForm());
    ...
    public static Pane townBuildings(){
        ...
        Image image = new Image(Under.class.getResource("/Images/buildings2/Town Buildings/t2.gif").toExternalForm());
        ImageView imageView = new ImageView(image);
        imageView.setFitWidth(70);
        imageView.setFitHeight(70);
        imageView.setX(350);
        ...
        Image image1 = new Image(Under.class.getResource("/Images/buildings2/Town Buildings/t3.png").toExternalForm());
        ImageView imageView1 = new ImageView(image1);
        imageView1.setFitWidth(65);
        imageView1.setFitHeight(65);
        imageView1.setX(430);
        ...
        Image image2 = new Image(Under.class.getResource("/Images/buildings2/Town Buildings/t4.png").toExternalForm());
        ImageView imageView2 = new ImageView(image2);
        imageView2.setFitWidth(65);
        imageView2.setFitHeight(65);
        imageView2.setX(510);
        ...
        Image image4 = new Image(Under.class.getResource("/Images/buildings2/Town Buildings/t5.png").toExternalForm());
        ImageView imageView4 = new ImageView(image4);
        imageView4.setFitWidth(65);
        imageView4.setFitHeight(65);
        imageView4.setX(590);
        ...
        Image image6 = new Image(Under.class.getResource("/Images/buildings2/Town Buildings/t6.png").toExternalForm());
        ImageView imageView6 = new ImageView(image6);
        ...
        Image image0 = new Image(Under.class.getResource("/Images/buildings2/Town Buildings/t1.gif").toExternalForm());
    ...
    public static Pane foodBuildings(){
        ...
        Image image = new Image(Under.class.getResource("/Images/buildings2/Food Buildings/fi1.png").toExternalForm());
        ImageView imageView = new ImageView(image);
        imageView.setFitWidth(70);
        imageView.setFitHeight(70);
        imageView.setX(350);
        ...
        Image image1 = new Image(Under.class.getResource("/Images/buildings2/Food Buildings/fi2.png").toExternalForm());
        ImageView imageView1 = new ImageView(image1);
        imageView1.setFitWidth(65);
        imageView1.setFitHeight(65);
        imageView1.setX(430);
        ...
        Image image2 = new Image(Under.class.getResource("/Images/buildings2/Food Buildings/fi3.gif").toExternalForm());
        ImageView imageView2 = new ImageView(image2);
        ...
        Image image3 = new Image(Under.class.getResource("/Images/buildings2/Food Buildings/fi4.gif").toExternalForm());
        ImageView imageView3 = new ImageView(image3);
    ...
    public static Pane weaponBuildings(){
        ...
        Image image = new Image(Under.class.getResource("/Images/buildings2/Weapons Buildings/w1.gif").toExternalForm());
        ImageView imageView = new ImageView(image);
        imageView.setFitWidth(70);
        imageView.setFitHeight(70);
        imageView.setX(350);
        ...
        Image image1 = new Image(Under.class.getResource("/Images/buildings2/Weapons Buildings/w2.png").toExternalForm());
        ImageView imageView1 = new ImageView(image1);
        imageView1.setFitWidth(65);
        imageView1.setFitHeight(65);
        imageView1.setX(430);
    ...
    public static Pane industryBuildings(){
        ...
        Image image = new Image(Under.class.getResource("/Images/buildings2/Industry buildings in Crusader/in1.gif").toExternalForm());
        ImageView imageView = new ImageView(image);
        ...
        Image image1 = new Image(Under.class.getResource("/Images/buildings2/Industry buildings in Crusader/in2.gif").toExternalForm());
        ImageView imageView1 = new ImageView(image1);
        ...
        Image image2 = new Image(Under.class.getResource("/Images/buildings2/Industry buildings in Crusader/in3.gif").toExternalForm());
        ImageView imageView2 = new ImageView(image2);
        ...
        Image image3 = new Image(Under.class.getResource("/Images/buildings2/Industry buildings in Crusader/in4.gif").toExternalForm());
        ImageView imageView3 = new ImageView(image3);
        ...
        Image image4 = new Image(Under.class.getResource("/Images/buildings2/Industry buildings in Crusader/in5.gif").toExternalForm());
        ImageView imageView4 = new ImageView(image4);
        ...
        Image image6 = new Image(Under.class.getResource("/Images/buildings2/Industry buildings in Crusader/in6.png").toExternalForm());
        ImageView imageView6 = new ImageView(image6);
        ...
        Image image7 = new Image(Under.class.getResource("/Images/buildings2/Industry buildings in Crusader/in7.png").toExternalForm());
    ...
    public static Pane farmBuildings(){
        ...
        Image image1 = new Image(Under.class.getResource("/Images/buildings2/farm buildings/dairy farmer.png").toExternalForm());
        ImageView imageView1 = new ImageView(image1);
        imageView1.setX(350);
        imageView1.setY(40);
        imageView1.setFitHeight(60);
        ...
        Image image2 = new Image(Under.class.getResource("/Images/buildings2/farm buildings/hops farmer.png").toExternalForm());
        ImageView imageView2 = new ImageView(image2);
        imageView2.setX(420);
        imageView2.setY(40);
        imageView2.setFitHeight(60);
        ...
        Image image3 = new Image(Under.class.getResource("/Images/buildings2/farm buildings/wheat farmer.png").toExternalForm());
        ImageView imageView3 = new ImageView(image3);
        imageView3.setX(490);
        imageView3.setY(40);
        imageView3.setFitHeight(60);
