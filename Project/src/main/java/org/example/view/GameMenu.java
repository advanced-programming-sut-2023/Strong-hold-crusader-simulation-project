...
//    }
    ...
    public void start(Stage stage) throws Exception {
        ...
        VBox buttons = new VBox(); buttons.setSpacing(10); buttons.setLayoutX(1200); buttons.setLayoutY(800);
        ...
        tradeMenu.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                TradeMain tradeMain = new TradeMain(GameMenuController.getCurrentGame().getCurrentTurn().getOwner(), gameMenu);
                try {
